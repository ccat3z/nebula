...
func NewPacketConnConn(l *slog.Logger, conn net.PacketConn) *PacketConnConn {
...
func (u *PacketConnConn) ListenOut(r EncReader) error {
	...
	for {
		...
		if err != nil {
			...
			// Dampen unexpected message warns to once per minute (mirrors GenericConn)
...
func (u *PacketConnConn) SupportsMultipleReaders() bool {
	return false
}
